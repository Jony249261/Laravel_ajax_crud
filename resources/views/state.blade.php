...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mt-5">
                        <div class="card-title bg-primary pt-2 pb-2">
                            <h5 class="text-center"> Laravel Ajax Crud Operations</h5>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm1">
                                {{ csrf_field() }}
                                    ...
                                    <button id="submit1" class="btn btn-success">Add State</button>
                            </form>
                        </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card mt-5">
                        <div class="card-title bg-primary pt-2 pb-2">
                            <h5 class="text-center"> List Of State</h5>
                        </div>
                        <div class="card-body">
                        
                        <table id="stateAll" class="table table-bordered">
                    <thead>
                        <tr>
            ...
            var tables = $('#stateAll').DataTable( {
                ...
                columns: [
                    ...
                    { 
                        "data": null,
                        render: function(data, type, row) {
                            return `<button data-id="${row.id}" class="btn btn-info" data-toggle="modal" data-target="#exampleModal1" id="edit1"><i class="fa fa-edit"></i></button>`;
                        }
                    },
                    { 
                        "data": null,
                        render: function(data, type, row) {
                            return `<button data-id="${row.id}" class="btn btn-danger" id="delete1"><i class="fa fa-trash"></i></button>`;
                        }
                    }
                ]
            } );
